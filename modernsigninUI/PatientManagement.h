...
namespace HospitalManagement {
	...
	/// </summary>
	public ref class PatientManagement : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PatientManagement::typeid));
			...
			this->label9->Size = System::Drawing::Size(260, 33);
			this->label9->TabIndex = 15;
			this->label9->Text = L"Patient Management";
			...
			this->btProfile->Click += gcnew System::EventHandler(this, &PatientManagement::btProfile_Click);
			// 
			// pictureBox2
			// 
			...
			this->label3->Text = L"List of all Patients";
...
#pragma endregion
		...
		void LoadData() {
			sqlConn->Open();
			adapter = gcnew SqlDataAdapter("SELECT Id, firstName, lastName, gender, dateofBirth, phoneNumber, email, password, account FROM Patient", sqlConn);
