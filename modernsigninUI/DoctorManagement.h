...
namespace HospitalManagement {
	...
	/// <summary>
	/// Summary for DoctorManagement
	/// </summary>
	public ref class DoctorManagement : public System::Windows::Forms::Form
	{
	public:
		DoctorManagement(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DoctorManagement::typeid));
			...
			this->label9->Size = System::Drawing::Size(259, 33);
			this->label9->TabIndex = 15;
			this->label9->Text = L"Doctor Management";
			...
			this->btProfile->Click += gcnew System::EventHandler(this, &DoctorManagement::btProfile_Click);
			// 
			// pictureBox2
			// 
			...
			this->btnSave->Location = System::Drawing::Point(24, 452);
			this->btnSave->Name = L"btnSave";
			this->btnSave->Size = System::Drawing::Size(296, 61);
			this->btnSave->TabIndex = 13;
			this->btnSave->Text = L"Save Changes";
			this->btnSave->UseVisualStyleBackColor = false;
			this->btnSave->Click += gcnew System::EventHandler(this, &DoctorManagement::btnSave_Click);
			// 
			// dataView
			// 
			...
			this->dataView->Location = System::Drawing::Point(351, 83);
			this->dataView->Name = L"dataView";
			this->dataView->SelectionMode = System::Windows::Forms::DataGridViewSelectionMode::FullRowSelect;
			this->dataView->Size = System::Drawing::Size(882, 482);
			...
			this->btnEdit->Location = System::Drawing::Point(24, 352);
			this->btnEdit->Name = L"btnEdit";
			this->btnEdit->Size = System::Drawing::Size(296, 61);
			this->btnEdit->TabIndex = 12;
			this->btnEdit->Text = L"Edit a Doctor";
			this->btnEdit->UseVisualStyleBackColor = false;
			this->btnEdit->Click += gcnew System::EventHandler(this, &DoctorManagement::btnEdit_Click);
			// 
			// btnRemove
			// 
			...
			this->btnRemove->Location = System::Drawing::Point(24, 252);
			this->btnRemove->Name = L"btnRemove";
			this->btnRemove->Size = System::Drawing::Size(296, 61);
			this->btnRemove->TabIndex = 11;
			this->btnRemove->Text = L"Remove a Doctor";
			this->btnRemove->UseVisualStyleBackColor = false;
			this->btnRemove->Click += gcnew System::EventHandler(this, &DoctorManagement::btnRemove_Click);
			// 
			// btnAdd
			// 
			...
			this->btnAdd->Location = System::Drawing::Point(24, 152);
			this->btnAdd->Name = L"btnAdd";
			this->btnAdd->Size = System::Drawing::Size(296, 61);
			this->btnAdd->TabIndex = 9;
			this->btnAdd->Text = L"Add a Doctor";
			this->btnAdd->UseVisualStyleBackColor = false;
			this->btnAdd->Click += gcnew System::EventHandler(this, &DoctorManagement::btnAdd_Click);
			// 
			// DoctorManagement
			// 
			...
			this->Name = L"DoctorManagement";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"DoctorManagement";
			this->Load += gcnew System::EventHandler(this, &DoctorManagement::DoctorManagement_Load);
...
#pragma endregion
		...
		void LoadData() {
			sqlConn->Open();
			adapter = gcnew SqlDataAdapter("SELECT Id, firstName, lastName, gender, dateofBirth, phoneNumber, email, password, department, specialization, experienceYears, account FROM Doctor", sqlConn);
			...
			dataView->Columns["Id"]->HeaderText = "Id";
			...
			dataView->Columns["password"]->HeaderText = "Password";
	...
	private: System::Void DoctorManagement_Load(System::Object^ sender, System::EventArgs^ e) {
